...
import { MapPin, Search, Filter, Layers, Database, PlusCircle, Users, Calendar, Building, Rocket, Brain } from 'lucide-react';
      ...
      <div className="bg-gray-50 py-4 border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap gap-3">
            <a 
              href="/apply" 
              className="flex items-center px-4 py-2 bg-bhred text-white rounded-lg hover:bg-red-700 transition-colors"
            >
